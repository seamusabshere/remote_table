...
describe RemoteTable do
  it "opens a shapefile" do
    ...
    t[0]['upper_corner']['x'].must_equal -94.89999999999999
    t[0]['upper_corner']['y'].must_equal 49.7
    t[0]['lower_corner']['x'].must_equal -94.99999999999999
    t[0]['lower_corner']['y'].must_equal 49.6
